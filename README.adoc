[![Travis CI Build Status](https://img.shields.io/travis/arquillian/arquillian-container-weld/master.svg)](https://travis-ci.org/arquillian/arquillian-container-weld)
